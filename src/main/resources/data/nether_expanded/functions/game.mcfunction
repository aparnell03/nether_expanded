...
execute as @a if data entity @s {Dimension:"minecraft:the_nether"} at @a[tag=zombified_piglin] run summon zombified_piglin ~ ~ ~ {PersistenceRequired:1,CanPickUpLoot:1b,HandItems:[{Count:1,id:golden_sword},{Count:1,id:golden_pickaxe}],HandDropChances:[1.0f,1.0f],ActiveEffects:[{Id:11,Amplifier:0,Duration:30}]}
...
execute as @a if data entity @s {Dimension:"minecraft:the_nether"} at @a[tag=wither_skeleton] run summon wither_skeleton ~ ~ ~ {PersistenceRequired:1,CanPickUpLoot:1b,HandItems:[{Count:1,id:"nether_expanded:blackstone_sword"},{Count:1,id:"nether_expanded:blackstone_pickaxe"}],HandDropChances:[1.0f,1.0f],ActiveEffects:[{Id:11,Amplifier:0,Duration:30}]}
