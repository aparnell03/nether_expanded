...
import com.austin.nether_expanded.block.entity.ModBlastFurnaceBlockEntity;
import com.austin.nether_expanded.block.entity.ModBlockEntities;
import com.austin.nether_expanded.block.entity.ModFurnaceBlockEntity;
...
public class ModBlastFurnaceBlock extends AbstractFurnaceBlock {
    public ModBlastFurnaceBlock(Settings settings) {
        super(settings);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(world, type, ModBlockEntities.NETHER_BLAST_FURNACE);
    }
