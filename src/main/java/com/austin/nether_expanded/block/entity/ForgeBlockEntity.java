...
import com.austin.nether_expanded.recipe.ForgeRecipe;
import com.austin.nether_expanded.screen.ForgeScreenHandler;
import net.fabricmc.fabric.api.registry.FuelRegistry;
import com.austin.nether_expanded.item.ModItems;
import com.austin.nether_expanded.item.inventory.ImplementedInventory;
...
public class ForgeBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch (index) {
                    ...
                    case 2: return ForgeBlockEntity.this.fuelTime;
                    case 3: return ForgeBlockEntity.this.maxFuelTime;
                    default: return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    ...
                    case 2: ForgeBlockEntity.this.fuelTime = value; break;
                    case 3: ForgeBlockEntity.this.maxFuelTime = value; break;
                }
            }
    ...
    private static boolean hasRecipe(ForgeBlockEntity entity) {
        ...
        Optional<ForgeRecipe> match = world.getRecipeManager()
                .getFirstMatch(ForgeRecipe.Type.INSTANCE, inventory, world);
